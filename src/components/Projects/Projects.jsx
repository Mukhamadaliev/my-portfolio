                        ...
                        <div className='project' id='Projects'>
                            ...
                            <div className="div-project-max-1">
                                <div className="project-1">
                                    ...
                                    <a href="https://github.com/Mukhamadaliev/sayt-web.git"><i className=' i font-size-25 bx bxl-github'></i></a>
                                    <a href="https://sayt-web-six.vercel.app/"><i className=' i font-size-25 bx bx-link-external'></i></a>
                                </div>
                                <div className="project-2">
                                    ...
                                    <a href="https://github.com/Mukhamadaliev/amaliyot-belissimo.git"><i className=' i font-size-25 bx bxl-github'></i></a>
                                    <a href="https://amaliyot-belissimo.vercel.app/"><i className=' i font-size-25 bx bx-link-external'></i></a>
                                </div>
